...
// Hoisted at module level — created once, never recreated on re-renders.
...
// Static data lives outside all components — never recreated.
const SERVICES_DATA = [
  {
...
const ServiceItem = memo<ServiceItemProps>(({ icon, title, description, index }) => {
  ...
  // Depends only on index — stable across all other prop changes.
